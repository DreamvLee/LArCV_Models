...
class ASPP(nn.Module):  # from ASPP_Layer
    def __init__(self, inplanes, outplanes=16, nkernels=16, showsizes=False):
        ...
        # Block 5
        self.B5_pool = torch.nn.MaxPool2d(kernel_size=3, stride=stride, padding=1, dilation=1, return_indices=False, ceil_mode=False)
...
class ASPP_post(nn.Module):  # from ASPP_combine
    def __init__(self, inplanes, outplanes):
        ...
        self.ASPP_conv = nn.Conv2d(self.inplanes, self.outplanes, kernel_size=1, stride=2, padding=0, bias=True)
...
class Atrous_Sep_Conv(nn.Module):
    ...
    def __init__(self, num_classes=3, in_channels=3, inplanes=16, showsizes=False):
        ...
        # Separabel Convolutions | (1024, 3x3, s=1), (1024, 3x3, s=1), (1024, 3x3, s=1)
        ...
        self.ASPP_combine_layer = self.ASPP_combine(self.inplanes * 68, self.inplanes * 16)
    ...
    def forward(self, x):
        ...
        # Short Cut Connection 4 | (512, 1x1, s=2)
